(function () {
    ...
    var DEFAULT_SOURCE_NAME = 'NUMParser (UA)';
...
function startPlugin() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Приховати переглянуті',
                description: 'Приховувати переглянуті фільми та серіали'
            },
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: 'Поріг перегляду',
                description: 'Мінімальний відсоток перегляду для приховування контенту'
            },
            onChange: function (value) {
